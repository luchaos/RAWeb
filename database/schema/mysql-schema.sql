...
CREATE TABLE `Achievements` (
  ...
  KEY `achievements_author_index` (`Author`),
...
DROP TABLE IF EXISTS `CodeNotes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CodeNotes` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `memory_notes_game_id_index` (`GameID`),
...
CREATE TABLE `Friends` (
  ...
  `Updated` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `friends_user_index` (`User`),
  KEY `friends_friend_index` (`Friend`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `GameHashLibrary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `GameHashLibrary` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `SetRequest` (
  ...
  `Updated` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_game_list_entry_username_game_id_type_unique` (`User`,`GameID`,`type`),
...
CREATE TABLE `SiteAwards` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `siteawards_user_awarddata_awardtype_awarddataextra_unique` (`User`,`AwardData`,`AwardType`,`AwardDataExtra`),
  KEY `siteawards_user_index` (`User`),
...
CREATE TABLE `Subscription` (
  `SubjectType` enum('ForumTopic','UserWall','GameTickets','GameWall','GameAchievements','Achievement') NOT NULL,
  `SubjectID` int(10) unsigned NOT NULL,
  `UserID` int(10) unsigned NOT NULL,
  `State` tinyint(3) unsigned NOT NULL COMMENT 'Whether UserID is subscribed (1) or unsubscribed (0)',
  `Created` timestamp NULL DEFAULT current_timestamp(),
  `Updated` timestamp NULL DEFAULT current_timestamp(),
...
CREATE TABLE `Ticket` (
  ...
  `ReportedByUserID` bigint(20) unsigned DEFAULT NULL,
  `game_hash_set_id` bigint(20) unsigned DEFAULT NULL,
  ...
  `ResolvedByUserID` bigint(20) unsigned DEFAULT NULL,
  `ReportState` tinyint(3) unsigned NOT NULL DEFAULT 1 COMMENT '1=submitted,2=resolved,3=declined',
  `Updated` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `tickets_ticketable_reporter_id_index` (`ticketable_model`,`ticketable_id`,`ReportedByUserID`),
  ...
  KEY `tickets_achievement_id_reporter_id_index` (`AchievementID`,`ReportedByUserID`),
...
CREATE TABLE `UserAccounts` (
  ...
  KEY `users_apptoken_index` (`appToken`),
  KEY `users_apikey_index` (`APIKey`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `game_hash_set_hashes` (
  ...
  CONSTRAINT `game_hash_set_hashes_game_hash_id_foreign` FOREIGN KEY (`game_hash_id`) REFERENCES `GameHashLibrary` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `messages_userto_index` (`UserTo`),
...
CREATE TABLE `player_games` (
  ...
  CONSTRAINT `player_games_game_hash_id_foreign` FOREIGN KEY (`game_hash_id`) REFERENCES `GameHashLibrary` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `player_sessions` (
  ...
  CONSTRAINT `player_sessions_game_hash_id_foreign` FOREIGN KEY (`game_hash_id`) REFERENCES `GameHashLibrary` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `websockets_statistics_entries` (
  ...
  `peak_connection_count` int(10) unsigned NOT NULL,
  `websocket_message_count` int(10) unsigned NOT NULL,
  `api_message_count` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2014_10_12_000001_create_password_reset_tokens_table',1);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2023_11_06_000000_create_player_stats_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2023_11_09_000000_update_site_awards_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2023_11_11_131859_add_event_column_to_activity_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2023_11_11_131900_add_batch_uuid_column_to_activity_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2023_11_19_000000_update_user_accounts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2023_11_20_000000_update_player_stats_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2023_11_25_000000_create_message_threads_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2023_11_25_000001_create_message_thread_participants',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2023_11_25_000002_update_messages_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2023_12_03_160441_drop_activity_and_awarded_tables',1);
